# Passive Live Memory Coherence Receiver Runtime Test Harness Consumption Rehearsal Consumption v0.50.1

The harness input envelope contains 4 source-bound receiver-facing blocks from v0.49.5. Each block is consumed as local test input with `consumedAsLocalTestInput=true`, `rawPersisted=false`, and `agentConsumedOutput=false`.
