# Status — Synaptic Mesh v0.27.0-alpha

Passive observation repeatability scorecard ladder. Status remains local-only, passive-only, read-only, disabled by default, non-authoritative, and human-readable only. policyDecision: null.
