# Synaptic Mesh v0.2.4

Status: passive canary drift scorecard public review release `v0.2.4`; **manual, local, opt-in, record-only, no effects**; **not runtime-ready**; **not production/enforcement-ready**.
...
Current v0.2.4 status is narrower than the long-term protocol goal: this repository ships a **local shadow review package** with deterministic fixtures, evidence, and checks. It does not ship runtime integration.
...
- [Full v0.2.4 status snapshot](docs/status-v0.2.4.md) — complete release snapshot, included gates, expected review results, and boundaries.
