...
# Synaptic Mesh v0.8.4

Status: framework adapter reviewer runbook public review release `v0.8.4`; human review process documented; no real framework adapter; **not runtime-ready**; **not production/enforcement-ready**.

Current v0.8.4 status is narrower than the long-term protocol goal: this repository can guide human review of design/dry-run evidence. It does not implement a real framework adapter or authorize framework integration.
