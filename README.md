# Synaptic Mesh v0.3.0-alpha

Status: advisory-only human-readable passive canary report alpha public review release `v0.3.0-alpha`; **manual, local, opt-in, record-only, no effects**; **not runtime-ready**; **not production/enforcement-ready**.
...
Current v0.3.0-alpha status is narrower than the long-term protocol goal: this repository ships a **local shadow review package** with deterministic fixtures, evidence, and checks. It does not ship runtime integration.
...
- [Full v0.3.0-alpha status snapshot](docs/status-v0.3.0-alpha.md) — complete release snapshot, included gates, expected review results, and boundaries.
