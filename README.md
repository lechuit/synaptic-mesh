...
Current v0.2.3 status is narrower than the long-term protocol goal: this repository ships a **local shadow review package** with deterministic fixtures, evidence, and checks. It does not ship runtime integration.
...
- [Full v0.2.3 status snapshot](docs/status-v0.2.3.md) — complete release snapshot, included gates, expected review results, and boundaries.
