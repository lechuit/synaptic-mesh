# Synaptic Mesh v0.16.5

This is the public review release `v0.16.5`. Current v0.16.5 status is narrower than live runtime: tiny operator-run passive pilot readiness only, for one explicit local sample input at a time.
