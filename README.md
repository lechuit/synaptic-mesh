# Synaptic Mesh v0.3.3

Status: advisory report reproducibility/drift public review release `v0.3.3`; **manual, local, opt-in, record-only, no effects**; **not runtime-ready**; **not production/enforcement-ready**.
...
Current v0.3.3 status is narrower than the long-term protocol goal: this repository ships a **local shadow review package** with deterministic fixtures, evidence, and checks. It does not ship runtime integration.
...
- [Full v0.3.3 status snapshot](docs/status-v0.3.3.md) — complete release snapshot, included gates, expected review results, and boundaries.
