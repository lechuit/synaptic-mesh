# Synaptic Mesh v0.15.5

This is the public review release `v0.15.5`. Current v0.15.5 status is narrower than live runtime: passive live shadow readiness achieved for a local operator-run pilot only.
