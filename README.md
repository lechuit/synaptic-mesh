# Synaptic Mesh v0.1.14

Status: real-redacted manual dry-run pilot / pre-live shadow readiness release candidate `v0.1.14`; **not runtime-ready**; **not production/canary/enforcement-ready**.
...
Current v0.1.14 status is narrower:
...
```bash
npm --prefix implementation/synaptic-mesh-shadow-v0 run release:check -- --target v0.1.14
```
