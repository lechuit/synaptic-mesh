# Synaptic Mesh v0.1.13

Status: manual dry-run CLI / pre-live shadow readiness release candidate `v0.1.13`; **not runtime-ready**; **not production/canary/enforcement-ready**.
...
Current v0.1.13 status is narrower:
...
```bash
npm --prefix implementation/synaptic-mesh-shadow-v0 run release:check -- --target v0.1.13
```
