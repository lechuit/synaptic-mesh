# Synaptic Mesh v0.3.2

Status: advisory report misuse/failure catalog public review release `v0.3.2`; **manual, local, opt-in, record-only, no effects**; **not runtime-ready**; **not production/enforcement-ready**.
...
Current v0.3.2 status is narrower than the long-term protocol goal: this repository ships a **local shadow review package** with deterministic fixtures, evidence, and checks. It does not ship runtime integration.
...
- [Full v0.3.2 status snapshot](docs/status-v0.3.2.md) — complete release snapshot, included gates, expected review results, and boundaries.
